...
//                showSelectDialog();
    ...
    public void loadIng(String tips, boolean canBack) {
        ...
        dialog = new CustomProgressDialog(ShowBigImage.this, tips);
    ...
    private void showSelectDialog() {
        new ActionSheetDialog(ShowBigImage.this)
                .builder()
                .setCancelable(true)
        ...
        httpUtils.download(mImageUrl, FileUtils.SDPATH + savePath, new RequestCallBack<File>() {
            ...
            public void onSuccess(ResponseInfo<File> responseInfo) {
                ...
                if (200 == responseInfo.statusCode) {
                    UIHelper.ToastMessage(ShowBigImage.this, "保存成功，在sd下的TX_SAVE_PHOTO文件夹下查看");
                } else {
                    UIHelper.ToastMessage(ShowBigImage.this, "保存失败");
                }
            }
