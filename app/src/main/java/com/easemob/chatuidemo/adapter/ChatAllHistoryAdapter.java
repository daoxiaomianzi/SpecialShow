...
public class ChatAllHistoryAdapter extends ArrayAdapter<EMConversation> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (conversation.getType() == EMConversationType.GroupChat) {
			...
			getEmidData(username, holder.avatar, holder.name);
		}
	...
	private void getEmidData(final String username, final ImageView avatar,
		...
		TXApplication.post(null, getContext(), url, params,
				new RequestCallBack<String>() {

					@Override
					public void onFailure(HttpException error, String msg) {
						UIHelper.ToastMessage(getContext(),
	...
	private class ConversationFilter extends Filter {
		...
		public ConversationFilter(List<EMConversation> conversationList) {
			mOriginalValues = conversationList;
		}
