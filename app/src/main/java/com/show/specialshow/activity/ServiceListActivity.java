...
public class ServiceListActivity extends BaseActivity {
    ...
    private TextView service_list_nodata_tv;
    ...
    public void initView() {
        service_list_nodata_tv = (TextView) findViewById(R.id.service_list_nodata_tv);
        service_list_lv = (ListView) findViewById(R.id.service_list_lv);
        if (null == servicelist || servicelist.isEmpty()) {
            service_list_lv.setVisibility(View.GONE);
            service_list_nodata_tv.setVisibility(View.VISIBLE);
        } else {
