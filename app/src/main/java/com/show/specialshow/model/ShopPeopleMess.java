...
public class ShopPeopleMess implements Serializable {
    ...
    private String choice_artisans_id;//手艺人对应的个人id
    private String choice_artisans_staffid;//手艺人id

    public String getChoice_artisans_staffid() {
        return choice_artisans_staffid;
    }

    public void setChoice_artisans_staffid(String choice_artisans_staffid) {
        this.choice_artisans_staffid = choice_artisans_staffid;
    }
