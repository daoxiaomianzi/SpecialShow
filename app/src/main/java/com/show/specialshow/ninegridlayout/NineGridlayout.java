...
public class NineGridlayout extends ViewGroup {
    ...
    private int columns;//
    private int rows;//
    private List<ShopComcardStaPicsMess> listData;
    ...
    private void layoutChildrenView(int pxLeftAndRight){
    	ScreenTools screenTools=ScreenTools.instance(getContext());
        int totalWidth=screenTools.getScreenWidth()-screenTools.dip2px(pxLeftAndRight);
...
//            childrenView.setImageUrl(listData.get(i).getThumbnail_pic());
    ...
    public void setImagesData(List<ShopComcardStaPicsMess> lists,int pxLeftAndRight) {
        ...
        listData = lists;
        layoutChildrenView(pxLeftAndRight);
    }
