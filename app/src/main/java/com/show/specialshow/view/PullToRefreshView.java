...
//	private String mLastUpdateTime;
	...
	private void init() {
		...
		addHeaderView();
//		mHeaderImageView.setBackgroundResource(R.drawable.refresh_animation);
		mAnimDrawable = (AnimationDrawable)mHeaderImageView.getBackground();
	}
...
//		mAnimDrawable.start();
		...
		mHeaderUpdateTextView.setText(UIHelper.getLastUpdateTime());
//		mHeaderImageView.clearAnimation();
...
//		mHeaderImageView.setImageResource(R.drawable.icon_frame01_anim);
		mHeaderTextView.setText(R.string.xlistview_header_hint_normal);
