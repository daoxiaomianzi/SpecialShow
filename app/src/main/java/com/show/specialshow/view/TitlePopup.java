...
public class TitlePopup extends PopupWindow {
    ...
    public TitlePopup(Context context, int width, int height) {
        ...
        // 设置弹窗的宽度和高度
        setWidth(width);
        setHeight(DensityUtil.dip2px(context, 171));
...
//		setAnimationStyle(R.style.AnimHead);
    ...
    public void show(View view) {
        ...
        showAtLocation(view, popupGravity, mScreenWidth - LIST_PADDING
                - (getWidth() / 2), mRect.bottom + DensityUtil.dip2px(mContext, 10));
    }
    ...
    private void populateActions() {
        ...
        mListView.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                View vi_title = ViewHolder.get(convertView, R.id.vi_title);
...
//					textView.setCompoundDrawablePadding(1);
                ...
                if (position == mActionItems.size() - 1) {
                    vi_title.setVisibility(View.GONE);
                }
                return convertView;
            }
