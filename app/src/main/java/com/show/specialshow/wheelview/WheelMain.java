package com.show.specialshow.wheelview;
...
public class WheelMain {
	...
	private static int START_YEAR = 1950, END_YEAR = Calendar.getInstance().get(Calendar.YEAR);
	public View getView() {
		return view;
	}
	...
	public void initDateTimePicker(int year, int month, int day, int h, int m) {
		...
		int textSize = 0;
		if (hasSelectTime)
			textSize = (int) ((screenheight / 100) * 3);
		else
			textSize = (int) ((screenheight / 100) * 3.3);
