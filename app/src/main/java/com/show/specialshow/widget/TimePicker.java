package com.show.specialshow.widget;
...
public class TimePicker extends LinearLayout{
	...
	private void init(Context context){
		...
		LayoutParams lparams_hours = new LayoutParams(TXApplication.WINDOW_WIDTH/4,LayoutParams.WRAP_CONTENT);
		...
		mins.setLayoutParams(new LayoutParams(TXApplication.WINDOW_WIDTH/4,LayoutParams.WRAP_CONTENT));
