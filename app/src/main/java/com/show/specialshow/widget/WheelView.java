...
public class WheelView extends View {
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        if (maxLength > 0) {
//			float textWidth = FloatMath.ceil(Layout.getDesiredWidth("0", itemsPaint));//23以上不兼容
...
//            labelWidth = (int) FloatMath.ceil(Layout.getDesiredWidth(label, valuePaint));//23以上不兼容
