...
public final class CameraManager {
	 ...
	 * handlerletter. Make sure to clear the handlerletter so it will only
	 * receive one message.
	 */
	...
	/**
	 * A single preview frame will be returned to the handlerletter supplied.
	 * The data will arrive as byte[] in the message.obj field, with width and
