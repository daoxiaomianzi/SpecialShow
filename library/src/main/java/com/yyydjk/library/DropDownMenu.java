...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        underLine.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dpTpPx(0.7f)));
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        ...
        if (i < tabTexts.size() - 1) {
            ...
            LinearLayout.LayoutParams params = new LayoutParams(dpTpPx(0.5f), LinearLayout.LayoutParams.MATCH_PARENT);
            params.setMargins(0, dpTpPx(5), 0, dpTpPx(5));
